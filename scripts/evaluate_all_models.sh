...
python -m allennlp.run evaluate models/full/qfirst-model-2.tar.gz --evaluation-data-file http://qasrl.org/data/qasrl-v2/dense/dev.jsonl.gz --cuda-device -1 --include-package qfirst --overrides '{"dataset_reader": {"question_source": "turk", "min_answers": 6, "min_valid_answers": 5}, "metric": {"type": "beam_filtering", "filter": {"question_threshold": TODO, "span_threshold": TODO, "invalid_threshold": TODO}}'
# qfirst model, tuning (non-dense)
python -m allennlp.run evaluate models/full/qfirst-model-2.tar.gz --evaluation-data-file http://qasrl.org/data/qasrl-v2/orig/dev.jsonl.gz --cuda-device -1 --include-package qfirst --overrides '{"dataset_reader": {"min_answers": 3, "min_valid_answers": 3}, "metric": {"target": "e2e-f1"} }'
# qfirst model, eval (non-dense). TODO fill in with tuned thresholds
python -m allennlp.run evaluate models/full/qfirst-model-2.tar.gz --evaluation-data-file http://qasrl.org/data/qasrl-v2/orig/dev.jsonl.gz --cuda-device -1 --include-package qfirst --overrides '{"dataset_reader": {"min_answers": 6, "min_valid_answers": 5}, "metric": {"type": "beam_filtering", "filter": {"question_threshold": TODO, "span_threshold": TODO, "invalid_threshold": TODO}}'
...
python -m allennlp.run evaluate models/full/afirst-model.tar.gz --evaluation-data-file http://qasrl.org/data/qasrl-v2/orig/dev.jsonl.gz --cuda-device -1 --include-package qfirst --overrides '{ "dataset_reader": {"min_answers": 3, "min_valid_answers": 3}, "metric": {"type": "threshold", "span_threshold": 0.5} }'
