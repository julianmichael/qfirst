...
class ClausalAnnotationPipeline[SID: Reader: Writer: HasTokens](
  ...
  lazy val valAjaxService = new Service[ClausalAjaxRequest[SID]] {
    override def processRequest(request: ClausalAjaxRequest[SID]) = request match {
